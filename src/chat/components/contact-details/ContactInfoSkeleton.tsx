  ...
  return (
    <div className="p-4">
      <div className="flex flex-col items-center pb-6 border-b">
        ...
        <div className="h-4 w-24 bg-gray-300 animate-pulse rounded mb-3"></div>
        <div className="h-3 w-16 bg-gray-300 animate-pulse rounded"></div>
      </div>

      <div className="py-4 space-y-4">
        <div>
          <div className="h-4 w-40 bg-gray-300 animate-pulse rounded mb-2"></div>
      ...
      <div className="pt-4 border-t">
        <div className="h-9 w-full bg-gray-300 animate-pulse rounded"></div>
      </div>
    </div>
  );
}
